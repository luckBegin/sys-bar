...
const routes: Routes = [
	...
	{ path: '403', component: Exception403Component, canActivate: [RouteguardService] },
	{ path: '404', component: Exception404Component, canActivate: [RouteguardService] },
	{ path: '500', component: Exception500Component, canActivate: [RouteguardService] },
